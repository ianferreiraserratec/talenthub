    ...
    (() => {
      ...
      const methods = {
        ...
        runMatching: () => {
          ...
          return { run:matchingRun, vaga:jobs[0], resultados:matchingResults };
        },
